package com.mozhumz.balance.config.seata;
...
public class SeataAutoConfig {
	...
	public MybatisSqlSessionFactoryBean sqlSessionFactory(DataSourceProxy dataSourceProxy) throws Exception {
		...
		mybatisSqlSessionFactoryBean.setTypeAliasesPackage("com.mozhumz.balance.model.entity");
	...
	public GlobalTransactionScanner globalTransactionScanner() {
		return new GlobalTransactionScanner("seata-springcloud-balance", "my_test_tx_group");
	}
}
